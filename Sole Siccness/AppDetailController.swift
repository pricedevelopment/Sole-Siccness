...
//  Copyright © 2018 Chairman Price. All rights reserved.
//
...
class AppDetailController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    fileprivate func descriptionAttributedText() -> NSAttributedString {
        ...
        if let desc = app?.desc {
            attributedText.append(NSAttributedString(string: desc, attributes: [NSAttributedStringKey.font: UIFont.systemFont(ofSize: 11), NSAttributedStringKey.foregroundColor: UIColor.lightGray]))
        }
